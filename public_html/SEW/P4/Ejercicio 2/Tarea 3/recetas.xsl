...
<xsl:variable name = "condition" select ="'Pollo'"/>
<xsl:template match="/">
<xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html&gt;</xsl:text>
<html lang="es">
<head>
	<title>Ejercicio 2: Recetas que tienen el ingrediente pollo</title>
...
<body>
  ...
  <xsl:for-each select="recetas/receta">
	<xsl:if test="ingredientes/ingrediente/nombre =$condition">
    <article>
